...
// see "Anatomy of the SIFT method", http://www.ipol.im/pub/pre/82/
...
function showHistograms (descriptor) {
  ...
  // for (var i = 0; i <= numberOfHistograms; i++) {
  //   context.beginPath();
  //   context.strokeStyle = "rgb(100, 100, 100, 0.3)";
  //   context.moveTo(.5 + margin, margin + i * step);
  //   context.lineTo(.5 + margin + numberOfHistograms * step, margin + i * step);
  //   context.stroke();
  //   context.beginPath();
  //   context.lineWidth = 1;
  //   context.strokeStyle = "rgb(100, 100, 100, 0.3)";
  //   context.moveTo(margin + i * step, .5 + margin);
  //   context.lineTo(margin + i * step, .5 + margin + numberOfHistograms * step);
  //   context.stroke();
  // }
